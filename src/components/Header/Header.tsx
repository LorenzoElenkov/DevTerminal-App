...
const Header: React.FC<IProps> = ({ loginSignup, logout }: IProps) => {
        ...
        return (
          <StyledNav className="nav">
            ...
            {context.token === "" ? (
              ...
              <>
                <Link to='/profile' className="profile9link">My profile</Link>
...
const StyledNav = styled.nav`
  ...
  height: 48px;
  display: grid;
  grid-template-columns: 50px max-content repeat(4, max-content) 1fr repeat(
      3,
      max-content
    ) 50px;
